...
#pnkd
  ...
  def correctlink(self, lien, current, currentdir, proto):
    ...
    llien.find("gopher:", 0) == 0 or llien.find("irc:", 0) == 0:
      return None
    # Good protogocols or relatives links
    else:
...
#dbg    print "THIS IS SELF.TOWBROWSE in lswww IN GO"
#dbg    print self.tobrowse
    proxy = None
...
#!	This area can cause trouble sometimes
#dbg        print "THIS IS SELF.FORM_VALUES IN THE IF OF LSWWW"
#dbg        print self.form_values
      else:
#dbg        print "THIS IS SELF.FORM_VALUES IN THE ELSE OF LSWWW"
#dbg        print self.form_values.items()
